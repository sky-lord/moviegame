    ...
    success: function(data){
      data.forEach(function(game){
        ...
        $.ajax({
         ...
         if( gameData[0].popularity >= 5 == $('#popCats option:selected').val() == "1"){
            $('#gameContent').append('<div class="game"><img src="http:' + gameData[0].cover.url + '" /><a href="' + gameData[0].url + '"><div class="titles2">' + gameData[0].name + '</a></div></div>');
          }
            if ( gameData[0].popularity <= 5 == $('#popCats option:selected').val() == "5" ){
           $('#gameContent').append('<div class="game"><img src="http:' + gameData[0].cover.url + '" /><a href="' + gameData[0].url + '"><div class="titles2">' + gameData[0].name + '</a></div></div>');
          }
        }
        });
